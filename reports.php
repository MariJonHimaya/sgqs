        ...
        <form action="" id="marks-form">
            <div class="col-12">
                <div class="row align-items-end">
                    ...
                    <div class="form-group col-md-4">
                        <button class="btn-sm btn btn-primary rounded-5" type="button" id="filter">Filter</button>
                        <button class="btn-sm btn btn-success ms-3 rounded-5" type="button" id="print">Print</button>
                    </div>
                </div>
                <hr>
                <?php
