        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="py-2 px-1"><?php echo $row['fullname'] ?></td>
                    <td class="py-2 px-1"><?php echo $row['username'] ?></td>
                    <th class="text-center py-2 px-1">
                        <div class="btn-group" role="group">
                            <button id="btnGroupDrop1" type="button" class="btn btn-primary dropdown-toggle btn-sm rounded-1 py-1" data-bs-toggle="dropdown" aria-expanded="false">
                            Action
                            </button>
