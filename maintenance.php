        ...
        <div class="col-12 h-100">
            <div class="row h-100">
                <div class="col-md-6 h-100 d-flex flex-column">
                    <div class="w-100 d-flex border-bottom border-primary py-1 mb-1">
                        <div class="fs-5 col-auto flex-grow-1"><b>Component List</b></div>
                        <div class="col-auto flex-grow-0 d-flex justify-content-end">
                            <a href="javascript:void(0)" id="new_component" class="btn btn-primary btn-sm bg-gradient rounded-2" title="Add Component"><span class="fa fa-plus"></span></a>
                        </div>
                    </div>
                    <div class="h-100 overflow-auto border rounded-1 border-primary">
                        <ul class="list-group">
                            <?php 
                ...
                <div class="col-md-6 h-100 d-flex flex-column">
                    <div class="w-100 d-flex border-bottom border-primary py-1 mb-1">
                        ...
                        <div class="col-auto flex-grow-0 d-flex justify-content-end">
                            <a href="javascript:void(0)" id="new_subject" class="btn btn-primary btn-sm bg-gradient rounded-2" title="Add subject"><span class="fa fa-plus"></span></a>
                        </div>
                    </div>
                    <div class="h-100 overflow-auto border rounded-1 border-primary">
                        <ul class="list-group">
